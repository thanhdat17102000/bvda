        ...
        <div class="card-body">
                ...
                <div class="col-sm-10" style="">
                    <select class="form-control" id="id_category" name="m_id_category">
                        @foreach($showcategory as $key => $show)
                            ...
                            {{($show->m_id_parent == $updated->m_id_category) ? 'selected':''}}
                            {{($show->m_id_parent == 0) ? 'style=font-weight:bold':''}}
                            >{{$show->m_title}}</option>
                        @endforeach
                    </select>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong33" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 34 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong34" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 35 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong35" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 36 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong36" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 37 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong37" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 38 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong38"  placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 39 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong39"  placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                            <!-- size 40 -->
                            <div class="col-md-1">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="number" class="form-control" id="soluong40" placeholder="Nhập số lượng tồn kho">
                                </div>
                            </div>
                        </div>
                    </div>              
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10" style="">
                    ...
                    @if(json_decode($updated->m_picture))
                        @foreach(json_decode($updated->m_picture) as $picture)
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10" style="">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="m_status" value="2" {{($updated->m_status == 2) ? 'checked':''}} >
                        <label class="form-check-label" for="flexRadioDefault1">
                            Ẩn 
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="m_status" value="1" {{($updated->m_status == 1) ? 'checked':''}}>
