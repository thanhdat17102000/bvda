    ...
    <form class="form-horizontal" method="POST">
        ...
        <div class="card-body">
                    ...
                    <select name="parent" class="browser-default custom-select">
                        <option value="0" selected>Chọn danh mục gốc</option>
                            @foreach($categorySelect as $cate)
                                @if($cate->id == $category->m_id_parent)
                                    <option value="{{$cate->id}}" selected>{{$cate->m_title}}</option>
                                @else
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" value="{{$category->m_title}}" class="form-control" id="inputPassword3" placeholder="Tên danh mục">
                    @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" name="index" value="{{$category->m_index}}" class="form-control" id="inputPassword3" placeholder="Thứ tự">
                    @if ($errors->has('index'))
