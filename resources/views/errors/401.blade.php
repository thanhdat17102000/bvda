...
<body>
   ...
   <!-- auth-page wrapper -->
   <div  style="background-image: url('{{asset('Error/assets/images/error-401.png')}}'); background-repeat: round;" class="auth-page-wrapper py-5 d-flex justify-content-center align-items-center min-vh-100">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 text-center">
                    <div class="error-500 position-relative">
                        <img src="" alt="" class="img-fluid error-500-img error-img" />
                        <h1 class="title text-muted"></h1>
                    </div>
                    <div>
                        <h4></h4>
                        <p class="text-muted w-75 mx-auto"></p>
