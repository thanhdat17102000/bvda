    ...
    <div class="row">
            ...
            <div class="card-box">
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">Hành động khác</a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">Thao tác khác</a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">Đường dẫn riêng</a>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0 mb-3">Phân tích bán hàng</h4>
                ...
                <div class="widget-box-2">
                    ...
                    <div class="progress progress-bar-alt-success progress-sm">
                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="77" aria-valuemin="0"
                            ...
                            <span class="sr-only">Hoàn thành 77%</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0 mb-4">Thống kê</h4>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0 mb-3">Doanh số hằng ngày</h4>
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0">Doanh số hằng ngày</h4>

                <div class="widget-chart text-center">
                    <div id="morris-donut-example" dir="ltr" style="height: 245px;" class="morris-chart"></div>
                    <ul class="list-inline chart-detail-list mb-0">
                        <li class="list-inline-item">
                            <h5 style="color: #ff8acc;"><i class="fa fa-circle mr-1"></i>Loại A</h5>
                        </li>
                        <li class="list-inline-item">
                            <h5 style="color: #5b69bc;"><i class="fa fa-circle mr-1"></i>Loại B</h5>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-xl-4">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0">Thống kê</h4>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card-box widget-user">
                <div class="media">
                    <div class="avatar-lg mr-3">
                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle"
                            alt="user">
                    </div>
                    <div class="media-body overflow-hidden">
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card-box">
                ...
                <h4 class="header-title mb-3">Hộp thư</h4>

                <div class="inbox-widget">

                    <div class="inbox-item">
                        <a href="#">
                            <div class="inbox-item-img"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}"
                    ...
                    <div class="inbox-item">
                        <a href="#">
                            <div class="inbox-item-img"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <div class="inbox-item">
                        <a href="#">
                            <div class="inbox-item-img"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <div class="inbox-item">
                        <a href="#">
                            <div class="inbox-item-img"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}"
                                    class="rounded-circle" alt=""></div>
                    ...
                    <div class="inbox-item">
                        <a href="#">
                            <div class="inbox-item-img"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}"
                                    class="rounded-circle" alt=""></div>
        ...
        <div class="col-xl-8">
            <div class="card-box">
                ...
                <h4 class="header-title mt-0 mb-3">Dự án mới nhất</h4>
